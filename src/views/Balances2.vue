        ...
        <div v-else class="w-full grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2 xl:gap-3 mb-8">
            <article v-for="item in items" :key="item.id" class="border border-slate-300 rounded-lg shadow hover:shadow-lg px-3 md:px-5 bg-white dark:bg-darkgrey dark:border-lightgrey relative font-mono tracking-tight">
                ...
                <div class="w-full flex justify-around items-end gap-2 md:gap-3 xl:gap-4 mb-4 text-sm lg:text-base">
                    <button @click="comingSoon" class="bg-slate-700 text-white hover:bg-slate-700 flex justify-center gap-2 rounded py-1.5 px-4 items-center flex-grow">
                        List
                    ...
                    <button @click="() => openSendDialog(item)" title="Send" class="bg-blue-500 bg-gradient-to-r text-light from-lightblue to-darkblue hover:to-lightblue flex justify-center gap-2 rounded py-1.5 px-4 items-center">
